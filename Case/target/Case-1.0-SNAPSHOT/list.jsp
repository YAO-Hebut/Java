...
<div class="container">
    ...
    <form id="delSelectedForm" action="${pageContext.request.contextPath}/DelSelectedServlet" method="post">
            ...
            <c:forEach items="${pb.list}" var="users" varStatus="s">
                <tr>
                    ...
                    <td><a class="btn btn-default btn-sm "
                           href="${pageContext.request.contextPath}/FindUserServlet?id=${users.id}">修改</a>&nbsp;
                        <a class="btn btn-default btn-sm "
                           href="javascript:deleteUser(${users.id});">删除
                        </a></td>
                </tr>
            </c:forEach>
        </table>
    ...
    <div>
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                <span style="font-size:20px;margin: 5px;text-align: center">共${pb.totalCount}行，共${pb.totalPage}页</span>
            </ul>
        </nav>
    </div>
</div>
